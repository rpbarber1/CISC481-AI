...
def updateWeights(network, expected_vector):
    ...
    while(len(tmp) != 0): #repeat for each hidden layer
        for i in range(len(tmp)): # for each unit
            ...
            deltaJ = tmp[i].output * (1 - tmp[i].output) * sumnation_children
...
test_network_1 = buildNetwork(10,9,1,10)
test_network_2 = buildNetwork(10,9,1,10)
test_network_3 = buildNetwork(10,9,1,10)

#Test Network

# FIRST TEST: 500 EPOCHS
train(test_network_1, training_list,500)
print("\n500 Epochs:")
acc = test(test_network_1, training_list, 0.89999)
print("\tAccuracy Threshold = 0.89999\n\t\t",acc)
acc = test(test_network_1, training_list, 0.94999)
print("\tAccuracy Threshold = 0.94999\n\t\t",acc)
acc = test(test_network_1, training_list, 0.98999)
print("\tAccuracy Threshold = 0.98999\n\t\t",acc)
print("==========================================\n")

# SECOND TEST: 750 EPOCHS
train(test_network_2, training_list,750)
print("\n750 Epochs:")
acc = test(test_network_2, training_list, 0.89999)
print("\tAccuracy Threshold = 0.89999\n\t\t",acc)
acc = test(test_network_2, training_list, 0.94999)
print("\tAccuracy Threshold = 0.94999\n\t\t",acc)
acc = test(test_network_2, training_list, 0.98999)
print("\tAccuracy Threshold = 0.98999\n\t\t",acc)
print("==========================================\n")
